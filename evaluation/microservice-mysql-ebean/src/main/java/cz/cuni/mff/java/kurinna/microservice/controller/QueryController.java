...
public class QueryController {
    ...
    public ResponseEntity<Map<String, Object>> getPricingSummary() {
        Map<String, Object> response = executeWithMeasurement(() -> {
            List<Map<String, Object>> result = queryService.getPricingSummary(90);
    ...
    public ResponseEntity<Map<String, Object>> getMinimumCostSupplier() {
        Map<String, Object> response = executeWithMeasurement(() -> {
            ...
            List<Map<String, Object>> result = queryService.getMinimumCostSupplier(size, type, region);
            Map<String, Object> data = new HashMap<>();
    ...
    public ResponseEntity<Map<String, Object>> getShippingPriority() {
        Map<String, Object> response = executeWithMeasurement(() -> {
            ...
            List<Map<String, Object>> result = queryService.getShippingPriority(segment, orderDate, shipDate);
            Map<String, Object> data = new HashMap<>();
    ...
    public ResponseEntity<Map<String, Object>> getOrderPriorityChecking() {
        Map<String, Object> response = executeWithMeasurement(() -> {
            ...
            List<Map<String, Object>> result = queryService.getOrderPriorityChecking(orderDate);
            Map<String, Object> data = new HashMap<>();
    ...
    public ResponseEntity<Map<String, Object>> getLocalSupplierVolume() {
        Map<String, Object> response = executeWithMeasurement(() -> {
            ...
            List<Map<String, Object>> result = queryService.getLocalSupplierVolume(region, orderDate);
            Map<String, Object> data = new HashMap<>();
